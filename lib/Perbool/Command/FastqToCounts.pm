package Perbool::Command::FastqToCounts;
...
Usage: perbool fastq to-counts [--in INPUT.fq[.gz]] [--out COUNTS.tsv[.gz]]
       fastq2count.pl < INPUT.fq > COUNTS.tsv

Count identical FASTQ sequences and print sorted SEQUENCE and COUNT columns.
Input and output default to standard streams; gzip files are supported.
USAGE
}
